...
public class EliteEnemyPlusAircraft extends AbstractEnemyAircraft {
    private final int shootNum = 3;//英雄机有三个子弹
     ...
     * @param hp        初始生命值
     */
    public EliteEnemyPlusAircraft(int locationX, int locationY, int speedX, int speedY, int hp) {
        super(locationX, locationY, speedX, speedY, hp);
        setShootStrategy(new ShootFanShaped());
    }
